...
const ButtonCheckout = ({ priceId, mode = "payment" }) => {
  ...
  return (
    <button
      className="flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 rounded-xl text-sm font-medium transition-all duration-200 shadow-lg hover:shadow-purple-500/20 group"
